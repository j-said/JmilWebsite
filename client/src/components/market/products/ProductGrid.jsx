            ...
            <section className="py-12">
                <div className="container mx-auto px-4">
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-[var(--foreground)] mb-4 theme-transition-colors">
                            No products found
                        </h2>
            ...
            <div className="container mx-auto px-4">
                ...
                {(title || subtitle) && (
                    <div className="text-center mb-8">
                        {title && (
                            <h2 className="text-3xl font-bold text-[var(--foreground)] mb-4 theme-transition-colors">
                                {title}
                            </h2>
                        )}
                        {subtitle && (
