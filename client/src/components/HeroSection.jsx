...
export default function HeroSection() {
    return (
        <section className="bg-[var(--background)] text-[var(--foreground)] py-24 px-4 text-center theme-transition">
            <div className="container mx-auto max-w-4xl">
                ...
                <p className="text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed text-[color-mix(in_oklab,var(--foreground)_80%,transparent)]">
